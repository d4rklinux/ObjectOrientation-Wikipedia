...
/**
 * Controller per la visualizzazione di una cella in una ListView di pagine associate alla home.
 */
public class CellHomepageController extends ListCell<Pagina> {
    ...
    void initialize() {
        ...
        readIcon.setOnMouseClicked(event -> {
            ...
            try {
                ...
                visualizzaPaginaController.setCellHomePageController(CellHomepageController.this);
 ...
 */
        ...
        if (empty || myPage == null) {
            ...
            if (fxmlLoader == null) {
                fxmlLoader = new FXMLLoader(getClass().getResource("/sample/view/CellHomepage.fxml"));
