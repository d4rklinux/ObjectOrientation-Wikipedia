 ...
 */
public class CellRicercaHomepageController extends ListCell<Pagina> {
...
// Metodo di inizializzazione, chiamato dopo il caricamento del layout FXML
    ...
    void initialize() {
        ...
        readIcon.setOnMouseClicked(event -> {
            ...
            try {
                ...
                visualizzaPaginaController.setCellRicercaHomepageController(CellRicercaHomepageController.this);
    ...
    protected void updateItem(Pagina myPage, boolean empty) {
        ...
        if (empty || myPage == null) {
            ...
            if (fxmlLoader == null) {
                fxmlLoader = new FXMLLoader(getClass().getResource("/sample/view/CellRicercaHomepage.fxml"));
